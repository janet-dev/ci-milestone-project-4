...
![PostgreSQL](https://img.shields.io/static/v1?label=PostgreSQL&message=0&color=brightgreen&logo=postgresql&logoColor=ffffff)
...
- ![ElephantDB](https://img.shields.io/static/v1?label=ElephantDB&message=5.0.15&color=brightgreen&logo=elephantdb&logoColor=ffffff)
    - [ElephantDB](https://www.elephantsql.com/) is used as a relational database plugin via Heroku.
