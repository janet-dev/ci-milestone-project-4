...
# Automated Testing using ChatGPT
...
I decide to generate these tests for the Blog app files *models.py* and *urls.py*. The test code was added to the app's **test.py** file in this directory:
...
The test were run by typing in to the terminal:
```
